...
namespace Movie_Booking.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Manali()
        {
            ...
            {
                ViewBag.Message = "Your Kashmir page.";

                return View();
            }
        public ActionResult Agra()
        {
            ViewBag.Message = "Your Agra page.";

            return View();
        }
        public ActionResult Kerala()
        {
            ViewBag.Message = "Your Kerala page.";
        ...
        {
            ViewBag.Message = "Your Rajasthan page.";

            return View();
        }
        public ActionResult Pondicherry()
        {
            ViewBag.Message = "Your Pondicherry page.";
